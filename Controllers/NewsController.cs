...
namespace MvcNews.Controllers
{
    public class NewsController : Controller
    {
        ...
        {
            var defNewsItem = new NewsItem();
            defNewsItem.TimeStamp = System.DateTime.Now;
            return View(defNewsItem);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,TimeStamp,Text,RowVersion")] NewsItem newsItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException)
                {
                    ...
                    {
                        ModelState.AddModelError("","Edited data has been modified or deleted by another user.");
                        return View(newsItem);
                    }
                }
                return RedirectToAction(nameof(Index));
